...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'job_freelance': '自由职业',
    'career_outlook': '职业前景',
    'career_outlook_hint': '评估晋升速度与股权激励带来的未来增量。',
    'optional': '选填',
    'equity_optional_placeholder': '没有则不填',
    'promotion_cycle': '平均晋升周期',
    'promotion_cycle_1': '1年（极快）',
    'promotion_cycle_2': '2年（较快）',
    'promotion_cycle_3': '3年（普通）',
    'promotion_cycle_5': '5年+（缓慢）',
    'annual_equity_value': '年均期权/股票价值',
    'is_public_company': '是否已上市/可变现',
    ...
    'share_future_value': '未来价值',
    'share_promotion_cycle_label': '平均晋升周期',
    'share_promotion_factor_label': '晋升乘子',
    'share_equity_value_label': '年均期权价值',
    'share_equity_realization_label': '是否已上市',
    'share_year_unit': '年',
    'share_future_value_fast': '职业流速极快，短周期晋升会持续放大这份工作的未来回报。',
    'share_future_value_slow': '晋升节奏偏慢，短期内更需要依赖当前岗位体验和现金流来支撑性价比。',
    'share_future_value_balanced': '晋升节奏处于常规区间，这份工作的未来价值主要取决于你后续的岗位成长空间。',
    'share_future_value_equity_rich': '潜在收益丰厚，股权激励已经成为总回报里不可忽视的一部分。',
    'share_future_value_equity_present': '这份工作还带着额外的股权筹码，未来兑现后会进一步改善整体回报。',
    'share_equity_bonus_applied': '包含期权潜在溢价。',
    ...
    'lawyer_ad_title': '遇到劳务纠纷？合同里有坑？Better Call Evan!',
    'lawyer_ad_subtitle': '李律（Evan Li）助你拿回属于自己的赔偿。',
    'lawyer_ad_services_title': '服务范围',
    'lawyer_ad_service_1': '劳务合同深度审核',
    'lawyer_ad_service_2': '劳动争议诉讼代理',
    'lawyer_ad_service_3': '离职补偿谈判',
    'lawyer_ad_hotline': '热线',
    'lawyer_ad_cta': 'CALL EVAN NOW!',
    'lawyer_ad_footer': 'NOT TOLL FREE • SE HABLA ESPAÑOL',
    'lawyer_ad_risk_badge': '高风险匹配',
    'lawyer_ad_risk_hint': '你的测算结果显示当前岗位存在较明显的劳动风险，建议尽快做合同审核或争议预案。',
    'lawyer_ad_image_alt': '李律劳务法律服务广告',
    'lawyer_ad_image_missing': '广告图资源待接入',
    'lawyer_ad_image_hint': '将你提供的广告图放到 public/lawyer-ad-evan.jpg 后，这里会自动显示正式图片。',
  },
  en: {
    ...
    'career_outlook_hint': 'Capture future upside from promotion speed and equity incentives.',
    'optional': 'Optional',
    'equity_optional_placeholder': 'Leave blank if none',
    'promotion_cycle': 'Promotion Cycle',
    'promotion_cycle_1': '1 year (very fast)',
    'promotion_cycle_2': '2 years (fast)',
    'promotion_cycle_3': '3 years (normal)',
    'promotion_cycle_5': '5+ years (slow)',
    'annual_equity_value': 'Annual Equity Value',
    'is_public_company': 'Is Public Company',
    ...
    'share_future_value': 'Future Value',
    'share_promotion_cycle_label': 'Promotion Cycle',
    'share_promotion_factor_label': 'Promotion Multiplier',
    'share_equity_value_label': 'Annual Equity Value',
    'share_equity_realization_label': 'Public / Liquid',
    'share_year_unit': ' years',
    'share_future_value_fast': 'Your career lane is moving quickly, and a short promotion cycle materially boosts the long-term upside of this role.',
    'share_future_value_slow': 'The promotion cadence is relatively slow, so near-term value depends more on current cash compensation and day-to-day experience.',
    'share_future_value_balanced': 'The promotion cadence is fairly standard, so the future value of this role depends on how much scope and responsibility you can keep accumulating.',
    'share_future_value_equity_rich': 'The upside looks substantial, and equity already represents a meaningful share of your total expected compensation.',
    'share_future_value_equity_present': 'There is still extra upside from equity, which could materially improve the package if it becomes realizable.',
    'share_equity_bonus_applied': 'Includes potential equity premium.',
    ...
    'lawyer_ad_title': 'In Legal Trouble? Better Call Evan!',
    'lawyer_ad_subtitle': 'Evan Li helps you recover the compensation you deserve.',
    'lawyer_ad_services_title': 'Services',
    'lawyer_ad_service_1': 'In-depth labor contract review',
    'lawyer_ad_service_2': 'Employment dispute litigation',
    'lawyer_ad_service_3': 'Severance and exit compensation negotiation',
    'lawyer_ad_hotline': 'Hotline',
    'lawyer_ad_cta': 'CALL EVAN NOW!',
    'lawyer_ad_footer': 'NOT TOLL FREE • SE HABLA ESPAÑOL',
    'lawyer_ad_risk_badge': 'High-risk match',
    'lawyer_ad_risk_hint': 'Your current result suggests elevated labor-law risk. A contract review or dispute strategy may be worth doing now.',
    'lawyer_ad_image_alt': 'Evan Li labor law services ad',
    'lawyer_ad_image_missing': 'Ad image not connected yet',
    'lawyer_ad_image_hint': 'Place your provided image at public/lawyer-ad-evan.jpg and this card will switch to the final creative automatically.',
  },
  ja: {
    // タイトルとナビゲーション
    ...
    'career_outlook': 'キャリア展望',
    'career_outlook_hint': '昇進スピードと株式報酬が将来価値に与える影響を反映します。',
    'optional': '任意',
    'equity_optional_placeholder': 'なければ入力不要',
    'promotion_cycle': '平均昇進周期',
    'promotion_cycle_1': '1年（非常に速い）',
    'promotion_cycle_2': '2年（やや速い）',
    'promotion_cycle_3': '3年（普通）',
    'promotion_cycle_5': '5年以上（遅い）',
    'annual_equity_value': '年間ストックオプション',
    'is_public_company': '上場済み / 換金可能',
    ...
    'share_future_value': '将来価値',
    'share_promotion_cycle_label': '平均昇進周期',
    'share_promotion_factor_label': '昇進倍率',
    'share_equity_value_label': '年間ストックオプション',
    'share_equity_realization_label': '上場済み',
    'share_year_unit': '年',
    'share_future_value_fast': '昇進の流れがかなり速く、この仕事は将来の伸びしろまで含めると非常に強いです。',
    'share_future_value_slow': '昇進ペースはやや遅めなので、短期的な満足度は今の給与や働きやすさに大きく左右されます。',
    'share_future_value_balanced': '昇進ペースは標準的で、今後どれだけ役割と裁量を広げられるかが将来価値を左右します。',
    'share_future_value_equity_rich': '潜在リターンは大きく、株式報酬は総報酬の中でも存在感のある要素です。',
    'share_future_value_equity_present': '株式報酬による上振れ余地があり、将来の実現次第で全体の条件がさらに良くなります。',
    'share_equity_bonus_applied': '株式報酬による潜在プレミアムを含みます。',
    ...
    'lawyer_ad_title': '労働トラブルでお困りですか？Evan弁護士にお任せください！',
    'lawyer_ad_subtitle': '李律（Evan Li）が、あなたが受け取るべき補償を取り戻すお手伝いをします。',
    'lawyer_ad_services_title': '対応内容',
    'lawyer_ad_service_1': '労働契約の詳細レビュー',
    'lawyer_ad_service_2': '労働紛争訴訟の代理',
    'lawyer_ad_service_3': '退職補償・和解交渉',
    'lawyer_ad_hotline': 'ホットライン',
    'lawyer_ad_cta': 'CALL EVAN NOW!',
    'lawyer_ad_footer': 'NOT TOLL FREE • SE HABLA ESPAÑOL',
    'lawyer_ad_risk_badge': '高リスク案件',
    'lawyer_ad_risk_hint': '今回の結果は労働リスクがやや高いことを示しています。契約レビューや紛争対応の準備を早めに進める価値があります。',
    'lawyer_ad_image_alt': '李律の労働法サービス広告',
    'lawyer_ad_image_missing': '広告画像は未接続です',
    'lawyer_ad_image_hint': '提供された画像を public/lawyer-ad-evan.jpg に置くと、このカードは自動で正式版に切り替わります。',
  }
};
